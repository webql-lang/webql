...
pub fn interpret_lexer_on_empty_input_test() {
...
pub fn interpret_lexer_on_a_single_integer_test() {
...
pub fn interpret_lexer_on_a_single_float_test() {
  let assert Ok(tokens) = lexer.lex(lexer.new("1.23"))

  assert tokens
    == [
      token.Token(kind: token.Float, span: source.Span(start: 0, end: 4)),
      token.Token(kind: token.EOF, span: source.Span(start: 4, end: 4)),
    ]
}

pub fn interpret_lexer_on_a_single_string_test() {
...
pub fn interpret_lexer_on_the_full_symbol_set_test() {
  let assert Ok(tokens) = lexer.lex(lexer.new("(){}[]:,=->."))

  assert tokens
    == [
      token.Token(kind: token.LParen, span: source.Span(start: 0, end: 1)),
      token.Token(kind: token.RParen, span: source.Span(start: 1, end: 2)),
      token.Token(kind: token.LBrace, span: source.Span(start: 2, end: 3)),
      token.Token(kind: token.RBrace, span: source.Span(start: 3, end: 4)),
      token.Token(kind: token.LSquare, span: source.Span(start: 4, end: 5)),
      token.Token(kind: token.RSquare, span: source.Span(start: 5, end: 6)),
      token.Token(kind: token.Colon, span: source.Span(start: 6, end: 7)),
      token.Token(kind: token.Comma, span: source.Span(start: 7, end: 8)),
      token.Token(kind: token.Equal, span: source.Span(start: 8, end: 9)),
      token.Token(kind: token.RArrow, span: source.Span(start: 9, end: 11)),
      token.Token(kind: token.Dot, span: source.Span(start: 11, end: 12)),
      token.Token(kind: token.EOF, span: source.Span(start: 12, end: 12)),
    ]
}

pub fn interpret_lexer_on_a_single_comment_test() {
...
pub fn interpret_lexer_on_a_single_whitespace_test() {
  let assert Ok(tokens) = lexer.lex(lexer.new(" \t\n"))

  assert tokens
    == [
      token.Token(kind: token.Space, span: source.Span(start: 0, end: 3)),
      token.Token(kind: token.EOF, span: source.Span(start: 3, end: 3)),
    ]
}

pub fn interpret_lexer_on_a_mixed_stream_test() {
  let assert Ok(tokens) = lexer.lex(lexer.new("(123) -> \"hi\", # ok\n[]"))

  assert tokens
    == [
      token.Token(kind: token.LParen, span: source.Span(start: 0, end: 1)),
      token.Token(kind: token.Int, span: source.Span(start: 1, end: 4)),
      token.Token(kind: token.RParen, span: source.Span(start: 4, end: 5)),
      token.Token(kind: token.Space, span: source.Span(start: 5, end: 6)),
      token.Token(kind: token.RArrow, span: source.Span(start: 6, end: 8)),
      token.Token(kind: token.Space, span: source.Span(start: 8, end: 9)),
      token.Token(kind: token.String, span: source.Span(start: 9, end: 13)),
      token.Token(kind: token.Comma, span: source.Span(start: 13, end: 14)),
      token.Token(kind: token.Space, span: source.Span(start: 14, end: 15)),
      token.Token(
        kind: token.CommentSingle,
        span: source.Span(start: 15, end: 19),
      ),
      token.Token(kind: token.Space, span: source.Span(start: 19, end: 20)),
      token.Token(kind: token.LSquare, span: source.Span(start: 20, end: 21)),
      token.Token(kind: token.RSquare, span: source.Span(start: 21, end: 22)),
      token.Token(kind: token.EOF, span: source.Span(start: 22, end: 22)),
    ]
}

pub fn interpret_lexer_skips_comments_when_disabled_test() {
  ...
  assert tokens
    == [
      ...
      token.Token(kind: token.Int, span: source.Span(start: 8, end: 11)),
      token.Token(kind: token.EOF, span: source.Span(start: 11, end: 11)),
    ]
}

pub fn interpret_lexer_skips_whitespace_when_disabled_test() {
  ...
  assert tokens
    == [
      token.Token(kind: token.Int, span: source.Span(start: 2, end: 5)),
      token.Token(kind: token.EOF, span: source.Span(start: 5, end: 5)),
    ]
}

pub fn interpret_lexer_skips_comments_and_whitespace_when_disabled_test() {
  let lexer =
    lexer.new("# hello\n\t123")
  ...
  assert tokens
    == [
      token.Token(kind: token.Int, span: source.Span(start: 9, end: 12)),
      token.Token(kind: token.EOF, span: source.Span(start: 12, end: 12)),
    ]
}

pub fn interpret_lexer_on_a_single_upper_identifier_test() {
...
pub fn interpret_lexer_on_a_single_lower_identifier_test() {
...
pub fn interpret_lexer_fails_on_invalid_symbol_test() {
...
pub fn interpret_lexer_fails_on_invalid_symbol_after_valid_tokens_test() {
  let assert Error(diagnostic.Diagnostic(
    kind: diagnostic.IllegalToken,
...
pub fn interpret_lexer_recovers_on_invalid_symbol_test() {
...
pub fn interpret_lexer_recovers_on_invalid_symbol_after_valid_tokens_test() {
...
pub fn interpret_lexer_on_basic_syntax_test() {
  let source =
  ...
  assert tokens
    == [
      ...
      token.Token(kind: token.Space, span: source.Span(start: 8, end: 9)),
      token.Token(kind: token.Equal, span: source.Span(start: 9, end: 10)),
      token.Token(kind: token.Space, span: source.Span(start: 10, end: 11)),
      token.Token(
        kind: token.LowerIdentifier,
        span: source.Span(start: 11, end: 13),
      ),
      token.Token(kind: token.Colon, span: source.Span(start: 13, end: 14)),
      token.Token(kind: token.Space, span: source.Span(start: 14, end: 15)),
      token.Token(
        kind: token.UpperIdentifier,
        span: source.Span(start: 15, end: 18),
      ),
      token.Token(kind: token.Space, span: source.Span(start: 18, end: 19)),
      token.Token(kind: token.RArrow, span: source.Span(start: 19, end: 21)),
      token.Token(kind: token.Space, span: source.Span(start: 21, end: 22)),
      token.Token(
        kind: token.LowerIdentifier,
        span: source.Span(start: 22, end: 25),
      ),
      token.Token(kind: token.Colon, span: source.Span(start: 25, end: 26)),
      token.Token(kind: token.Space, span: source.Span(start: 26, end: 27)),
      token.Token(
        kind: token.UpperIdentifier,
        span: source.Span(start: 27, end: 30),
      ),
      token.Token(kind: token.Space, span: source.Span(start: 30, end: 31)),
      token.Token(kind: token.LBrace, span: source.Span(start: 31, end: 32)),
      token.Token(kind: token.Space, span: source.Span(start: 32, end: 35)),
      token.Token(
        kind: token.LowerIdentifier,
        span: source.Span(start: 35, end: 36),
      ),
      token.Token(kind: token.Space, span: source.Span(start: 36, end: 37)),
      token.Token(kind: token.Equal, span: source.Span(start: 37, end: 38)),
      token.Token(kind: token.Space, span: source.Span(start: 38, end: 39)),
      token.Token(
        kind: token.UpperIdentifier,
        span: source.Span(start: 39, end: 43),
      ),
      token.Token(kind: token.Space, span: source.Span(start: 43, end: 47)),
      token.Token(kind: token.String, span: source.Span(start: 47, end: 57)),
      token.Token(kind: token.RArrow, span: source.Span(start: 57, end: 59)),
      token.Token(
        kind: token.LowerIdentifier,
