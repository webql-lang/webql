...
pub fn resolve_supernode_resolves_nested_graph_test() {
  ...
  let assert Ok(#(supernode, _context)) =
    resolve_supernode.resolve(
      schema,
      context.new(),
...
pub fn resolve_supernode_returns_duplicate_supernode_test() {
...
pub fn resolve_supernode_returns_duplicate_supernode_for_schema_node_test() {
